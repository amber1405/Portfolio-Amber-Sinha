...
const Navbar = () => {
  return (
    <div className="flex justify-around items-center shadow-sm text-white shadow-blue-600 ">
      <div>
      ...
      <button className="w-28 border-2 border-indigo-500 bg- font-semibold font-inter text-xl rounded-full text-richblack-25 hover:bg-purple-800 ease-in-out duration-500">
        Github
      </button>
    </div>
  );
